...
def calculate_retrieval_metrics(results, qrels, k_values=[1, 5, 10, 25, 50, 100]):
    ...
    #     qid_scores[qid] ={"ndcg_cut_1": score['ndcg_cut_1'],
    #                       "ndcg_cut_5": score['ndcg_cut_5'],
    #                       "ndcg_cut_10": score['ndcg_cut_10'],
    #                       "ndcg_cut_25": score['ndcg_cut_25'],
    #                       "ndcg_cut_50": score['ndcg_cut_50'],
    #                       "ndcg_cut_100": score['ndcg_cut_100']}
    #     #  (score['ndcg_cut_1']+score['ndcg_cut_5']+score['ndcg_cut_10']+score['ndcg_cut_25']+score['ndcg_cut_50']+score['ndcg_cut_100'])/6
