...
export BRIGHT_CACHE_DIR="../../0_reasoning_step_generation/cache/cache_diver-retriever"
export BRIGHT_BASE_DOC_DIR="../../0_reasoning_step_generation/data/BRIGHT/documents"
...
CUDA_VISIBLE_DEVICES=0,1 python3 -m verl.trainer.main_ppo \
    ...
    trainer.rollout_data_dir="rollout_data_batch" \
    ...
    data.train_files=RL_train_data/bright/part_48_49_50_rounds_train.parquet \
    data.val_files=RL_train_data/bright/part_48_49_50_rounds_dev.parquet \
